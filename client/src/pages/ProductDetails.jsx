                    ...
                    {images.length > 1 && (
                      <>
                        <button
                          ...
                          className="absolute left-4 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-white/80 hover:bg-white text-slate-800 shadow-md hover:scale-105 active:scale-95 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 cursor-pointer"
                        >
                          ←
                        </button>
                        <button
                          onClick={() => setActiveImageIndex((curr) => (curr === images.length - 1 ? 0 : curr + 1))}
                          className="absolute right-4 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-white/80 hover:bg-white text-slate-800 shadow-md hover:scale-105 active:scale-95 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 cursor-pointer"
                        >
                          →
                        </button>
