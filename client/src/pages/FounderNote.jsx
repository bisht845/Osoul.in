...
const FounderNote = () => {
  ...
  return (
    <div
      className="relative min-h-screen bg-[#FAF6EE] w-full flex items-center justify-center py-20 px-4 "
    style={{
    ...
    >
      ...
      <div className="relative z-10 bg-[#FAF6EE]/80  max-w-lg sm:max-w-2xl w-full p-8 sm:p-14 md:p-16 rounded-sm 2xl text-center space-y-6 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className='flex justify-center pt-8'>
          <img
            src={founderimg}
            alt="founder note"
            className="max-w-[380px] sm:max-w-[450px] w-full aspect-square rounded-lg shadow-sm object-cover"
          />
        </div>
      </div>
    </div>
